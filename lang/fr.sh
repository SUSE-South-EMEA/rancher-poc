### Script 01
DESC_CHECK_PACKAGE="Verification de la présence des paquets ?"
...
DESC_COPY_PROXY_CA="Copie de la clef privée du proxy vers les clients. Appliquer ces paramètres ?"
